...
pub trait EmbeddingStore: Send + Sync {
    fn store_embedding(&self, source_type: &str, source_id: &str, workspace_id: &str, text: &str, vector: &[f32]) -> MemoryResult<()>;
    fn search(&self, query_vector: &[f32], workspace_id: &str, top_k: usize, threshold: f32) -> MemoryResult<Vec<EmbeddingSearchResult>>;
